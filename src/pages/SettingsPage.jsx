...
import "../css/SettingsPage.css"; // Import the CSS file
...
const SettingsPage = () => {
  ...
  useEffect(() => {
    ...
    // Persist the settings immediately so theme survives reloads
    try {
      localStorage.setItem(STORAGE_KEY, JSON.stringify(settings));
    } catch (e) {
      // ignore storage errors
    }
  }, [settings.darkMode, settings]); // we persist whole settings as well
